...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { content: @advertisement.content, image: @advertisement.image, title: @advertisement.title }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { content: @advertisement.content, image: @advertisement.image, title: @advertisement.title }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
